...
export default function MealHistoryModal({ isOpen, onClose }: MealHistoryModalProps) {
  const [activeTab, setActiveTab] = useState<'log' | 'planner'>('log');
      ...
      <div className="meal-modal" onClick={(e) => e.stopPropagation()}>
        <div className="meal-modal-header">
          <div className="modal-title-section">
            <h2 className="modal-title">Meal Tracker</h2>
            <p className="modal-subtitle">Plan ahead & track your nutrition</p>
          </div>
